...
public class VelocityWrapper {
	...
	public static synchronized void initEngine(OAI2LODServer d2r, ServletContext servletContext) {
		try {
	...
	private static Context initDefaultContext(OAI2LODServer server) {
